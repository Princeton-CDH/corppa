...
def get_stub_dir(source: str, vol_id: str) -> Path:
    """
    Returns the stub directory path (:class:`pathlib.Path`) for the specified volume (``vol_id``)
...
def get_vol_dir(vol_id: str) -> Path:
    """
    Returns the volume directory (:class:`pathlib.Path`) for the specified volume (``vol_id``)
    """
