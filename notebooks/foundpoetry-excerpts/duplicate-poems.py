...
def _():
    ...
    excerpts_df
    return all_excerpts_df, data_paths, excerpts_df, pl
...
app._unparsable_cell(
    ...
    # for each unique poem id, how many poems does it match with?
...
def _(alt_poem_pairs_df, c):
    # for each unique alternate poem id, how many poems does it match with?
...
def _(all_excerpts_df, c, poem_ids):
    # what are some of the examples where the ids do not occur together?
...
def _(alt_poem_pairs_df, overlap_poem_pairs_df):
    # join the two sets of high-overlap poem ids
